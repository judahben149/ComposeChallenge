...
import com.judahben149.composechallenge.ui.theme.RedChip
import com.judahben149.composechallenge.ui.theme.sailecBold
...
fun TopAppBar(modifier: Modifier = Modifier, onToggle: () -> Unit) {
    ...
    Row() {
        ...
        Row(modifier.fillMaxWidth().padding(end = 16.dp, top = 10.dp), horizontalArrangement = Arrangement.End) {
            Icon(
